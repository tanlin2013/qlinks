...
=========
## 1.0.0 - TBD
- Pin NumPy below 2.5 across Python versions so the optional Numba 0.66 / llvmlite 0.48 tensor-network environment imports correctly in the Python 3.14 Docker image.
